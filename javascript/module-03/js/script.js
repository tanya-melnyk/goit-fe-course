...
// и верни true или false в зависимости от того, попадает ли длина параметра
...
// При этом для проверок условия добавления использует результаты вызовов других функций -
...
const isLoginUnique = function(allLogins, login) {
  ...
  if (allLogins.includes(login)) isLoginUnique = false;
...
console.log(addLogin(logins, 'Ajax'), logins); // 'Логин успешно добавлен!'
console.log(addLogin(logins, 'robotGoogles'), logins); // 'Такой логин уже используется!'
console.log(addLogin(logins, 'Zod'), logins); // 'Ошибка! Логин должен быть от 4 до 16 символов'
console.log(addLogin(logins, 'jqueryisextremelyfast'), logins); // 'Ошибка! Логин должен быть от 4 до 16 символов'
